...
function Slider({ slides }) {
  ...
  return (
    <div className="relative h-full mx-auto w-full ml-4">
      <div className="relative h-[384px] overflow-hidden rounded-md">
        <img
      ...
      <button
        className="absolute top-1/2 rounded-full left-0 transform -translate-y-1/2 px-2 py-2 bg-gray-600 text-white opacity-0 hover:opacity-100 transition-opacity duration-300"
